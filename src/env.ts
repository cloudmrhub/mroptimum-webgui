...
export const MRO_SERVER = process.env.MRO_SERVER || 'https://3ip95tbnkf.execute-api.us-east-1.amazonaws.com/Prod';
...
export const API_TOKEN = process.env.API_TOKEN || 'jdgWMwkSLF84OAKnAEQjZ8yHeloiKqkM7H7260ua';
