...
export default function UploadWindow({upload, open, setOpen, fileExtension,
                ...
                <DialogContent>
                    ...
                    <DialogContent dividers>
                        <Box width={500} height={250}
                             style={{borderStyle:'dashed', borderRadius:'5pt', borderColor:(uploadBoxWarning==undefined)?'lightGray':'#BA3C3C'}}>
                    ...
                    <DialogActions>
                        <Button color={'inherit'} sx={{color:'#333'}} disabled={UpBtnDisabled} onClick={handleClose}>Cancel</Button>
                        <Button variant='contained' disabled={UpBtnDisabled} onClick={handleConfirm}>{UpBtnText}</Button>
                    </DialogActions>
                </DialogContent>
            </Dialog>
        </div>
