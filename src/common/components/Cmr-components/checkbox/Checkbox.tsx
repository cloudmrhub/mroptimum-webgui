...
const CmrCheckbox = (props: CmrCheckboxProps) => {
    ...
    return (
        <FormControlLabel disabled={props.disabled} className={props.className} control={<Checkbox checked={props.checked} defaultChecked={defaultChecked} onChange={onChange}/>}
