  ...
  return (
    ...
    >
      ...
      >
        ...
        <Card
          variant="outlined"
          sx={{ mb: 2, borderTopLeftRadius: 0, borderTopRightRadius: 0 }}
        >
          <CardContent>
            <Box
              style={{
            ...
            >
              ...
              <DualSlider
                ...
                max={
                  props.nv.volumes[0]
                    ? (props.nv.volumes[0].cal_max ??
                      props.nv.volumes[0].robust_max)
                    : 1
                }
                min={
                  props.nv.volumes[0]
                    ? (props.nv.volumes[0].cal_min ??
                      props.nv.volumes[0].robust_min)
                    : 0
                }
                setMin={(min) => {
                  ...
                  volume.cal_min = min;
                  props.nv.refreshLayers(
                    props.nv.volumes[0],
                    0,
                    props.nv.volumes.length,
                  );
                  props.nv.drawScene();
                  props.setMin(min);
                }}
