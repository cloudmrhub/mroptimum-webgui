export const snrDescriptions:{[key:string]:string} = {
    ...
    Wiens CN, Kisch SJ, Willig-Onwuachi JD, McKenzie CA. Computationally rapid method of estimating signal-to-noise ratio for phased array image reconstructions. Magn Reson Med. 2011 Oct;66(4):1192-7. doi: <a href="https://pubmed.ncbi.nlm.nih.gov/21465545/" target="_blank">10.1002/mrm.22893</a>`,
}
