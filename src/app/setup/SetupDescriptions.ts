...
export const snrDescriptions:{[key:string]:string} = {
    ...
    $$\\newline$$
          ...
          Kellman P, McVeigh ER. Image reconstruction in SNR units: a general method for SNR measurement.  Magn Reson Med. 2005 Dec;54(6):1439-47. 
            doi: 10.1002/mrm.20713. Erratum in: Magn Reson Med. 2007 Jul;58(1):211-2 <a href="https://pubmed.ncbi.nlm.nih.gov/16261576/" target="_blank"><img src="${linkIcon}" alt="link icon" style="height:0.7em;margin-left:0px;vertical-align:top;"></a>`,
    ...
    $$\\newline$$
    Robson PM, Grant AK, Madhuranthakam AJ, Lattanzi R, Sodickson DK, McKenzie CA. Comprehensive quantification of signal-to-noise ratio and g-factor for image-based and k-space-based parallel imaging reconstructions. Magn Reson Med. 2008 Oct;60(4):895-907 <a href="https://pubmed.ncbi.nlm.nih.gov/18816810/" target="_blank"><img src="${linkIcon}" alt="link icon" style="height:0.7em;margin-left:0px;vertical-align:top;"></a>`,
    ...
    Wiens CN, Kisch SJ, Willig-Onwuachi JD, McKenzie CA. Computationally rapid method of estimating signal-to-noise ratio for phased array image reconstructions. Magn Reson Med. 2011 Oct;66(4):1192-7<a href="https://pubmed.ncbi.nlm.nih.gov/21465545/" target="_blank"><img src="${linkIcon}" alt="link icon" style="height:0.7em;margin-left:0px;vertical-align:top;"></a>`
}
